    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="flex items-center gap-4 mb-12">
          <span className="text-xs font-black tracking-[0.32em] uppercase text-[#0a0a0a]">03</span>
          <div className="flex-1 h-[2px] bg-[#0a0a0a]" />
          <span className="text-xs font-black tracking-[0.32em] uppercase text-[#0a0a0a]/60">Skills</span>
        </div>
